...
def multiply(expr1, expr2):
    ...
    res = do_multiply(expr1, expr2)
    # For debugging
    # print(str(Product([expr1, expr2])) + ' => ' + str(res))
    return res
...
def do_multiply(expr1, expr2):
    ...
    * expr1 is a Product, and expr2 is a Product
    ...
    if isinstance(expr1, Sum) and isinstance(expr2, Sum):
        ...
        # Distributive law
        return Sum([multiply(elem, expr2) for elem in expr1])
    elif isinstance(expr1, Product) and isinstance(expr2, Sum):
        # handled in previous branch
        return multiply(expr2, expr1)
    elif isinstance(expr1, Product) and isinstance(expr2, Product):
        # Associative law
        return Product(expr1 + expr2)
    else:
        raise ValueError('uncovered: multiply({}, {})'.format(expr1, expr2))
